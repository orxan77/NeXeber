...
public class FragmentRussian extends Fragment {

    private static final String LOG_TAG = FragmentEnglish.class.getSimpleName();
    int pastVisibleItems, visibleItemCount, totalItemCount;
    int pageNumber = 2;
    private RecyclerView mRecyclerView;
    private NewsAdapter mNewsAdapter;
    private List<News> mNewsList;
    private List<News> mPreviousList;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fetchData(NetworkUtils.URL_RUSSIAN_NEWS);
        implementScrollListener(NetworkUtils.URL_RUSSIAN_NEWS);
        return view;
    }
